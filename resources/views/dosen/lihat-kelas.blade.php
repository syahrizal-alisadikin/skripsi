                                    ...
                                    <tr>
                                        <td colspan="4" class="text-center">Belum Ada Materi <br>
                                          {{-- <form action="{{ route('upload.materi') }}" method="POST" enctype="multipart/form-data">
                                             @csrf
                                             <input name="materi" type="file" class="btn btn-primary" class="form-control">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('process.absen') }}" method="POST">
                        ...
                        <div class="form-group">
                            <input type="text" id="matkul" class="form-control" value="{{$data->name}}">
                            <input type="hidden" name="id_jadwal" id="matkul" class="form-control" value="{{$data->id}}">
                        </div>
                        <div class="form-group">
