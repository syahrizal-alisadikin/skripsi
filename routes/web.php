...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::resource('namamatkul', 'NamaMatkulController');
...
Route::prefix('dosen')->namespace('Dosen')
    ->group(function () {
        ...
        Route::get('absen/dosen', 'DosenController@absen_dosen')->name('absen-dosen');
        Route::get('jadwal/dosen', 'DosenController@jadwal_dosen')->name('jadwal_dosen');
